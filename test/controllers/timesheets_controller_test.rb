...
class TimesheetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timesheet" do
    assert_difference('Timesheet.count') do
      post timesheets_url, params: { timesheet: { date_of_entry: @timesheet.date_of_entry, finish_time: @timesheet.finish_time, start_time: @timesheet.start_time } }
    end
  ...
  test "should update timesheet" do
    patch timesheet_url(@timesheet), params: { timesheet: { date_of_entry: @timesheet.date_of_entry, finish_time: @timesheet.finish_time, start_time: @timesheet.start_time } }
